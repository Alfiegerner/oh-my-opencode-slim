...
On v2-compatible hosts (OpenCode with TUI plugin v2), the typed shortcut
`/preset opencode-go` applies directly. On older hosts, open `/preset` from
autocomplete and pick Apply from the preset list.
